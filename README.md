...
ℹ️ Some paragraph have been generated by AI for time saving and a better page setting

## 📚 Table of Contents

- [Rook-ceph Kubernetes Deployment](#rook-ceph-kubernetes-deployment)
- [Requirements](#requirements)
- [QuickStart Guide](#quickstart-guide)
  - [Install Rook-ceph following quickstart](#install-rook-ceph-following-quickstart)
  - [Create the Ceph cluster](#create-the-ceph-cluster)
  - [Cluster status](#cluster-status)
- [Ceph in Kubernetes](#ceph-in-kubernetes)
  - [Install Ceph kube plugin](#install-ceph-kube-plugin)
- [Storage configuration](#storage-configuration)
  - [Storage type](#storage-type)
  - [CephBlockPool configuration](#cephblockpool-configuration)
    - [Create a CephBlockPool configuration file](#create-a-cephblockpool-configuration-file)
    - [Create a CephBlock storageclass for your PVCs](#create-a-cephblock-storageclass-for-your-pvcs)
    - [Create a CephFS configuration file](#create-a-cephfs-configuration-file)
    - [Create a CephFS storageclass for your PVCs](#create-a-cephfs-storageclass-for-your-pvcs)
- [Dashboard configuration](#dashboard-configuration)
- [Tricks](#tricks)
  - [Set the Block storageclass as default](#set-the-block-storageclass-as-default)
